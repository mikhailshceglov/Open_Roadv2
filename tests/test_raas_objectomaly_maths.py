...
Added by the raas-objectomaly branch. Nothing here loads a model: the whole point of pulling
...
from methods.raas_objectomaly import clip_filter, road_aware, soft_mask
from methods.raas_objectomaly.soft_mask import VOID_CLASS
